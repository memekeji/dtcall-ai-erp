...
! function(d) {
	...
	var t, h = d.document,
		...
		n = (Array.prototype.indexOf = Array.prototype.indexOf || function(n, i) {
			...
			}, c = "margin" in n ? n.margin : 5, l = i.left, "center" === n.align ? l -= (a - t.offsetWidth) / 2 : "right" === n.align && (l = l - a + t.offsetWidth), (l = l + a + c > o("width") ? o("width") - a - c : l) < c && (l = c), (a = i.bottom) + u + c > o() && (i.top > u + c && i.top <= o() ? a = i.top - u - 2 * c : n.allowBottomOut || (a = o() - u - 2 * c) < 0 && (a = 0)), (u = n.position) && (e.style.position = u), s = n.offset ? n.offset[0] : 0, f = n.offset ? n.offset[1] : 0, e.style.left = l + ("fixed" === u ? 0 : r(1)) + s + "px", e.style.top = a + ("fixed" === u ? 0 : r()) + f + "px", p.hasScrollbar() || (l = e.getBoundingClientRect(), !n.SYSTEM_RELOAD && l.bottom + c > o() && (n.SYSTEM_RELOAD = !0, setTimeout(function() {
				p.position(t, e, n)
			}, 50))))
			...
			a && p.touchEventsSupported() && (n = {
				...
				1 === t.touches.length && (a.addEventListener("touchmove", i, !!p.passiveSupported && {
					passive: !1
				}), a.addEventListener("touchend", r), a.addEventListener("touchcancel", r), n.timeStart = Date.now(), n.pointerStart.x = n.pointerEnd.x = t.touches[0].clientX, n.pointerStart.y = n.pointerEnd.y = t.touches[0].clientY, n.distanceX = n.distanceY = 0, n.direction = "none", c.onTouchStart) && c.onTouchStart(t, n)
			}, i = function(t) {
				t.preventDefault(), n.pointerEnd.x = t.touches[0].clientX, n.pointerEnd.y = t.touches[0].clientY, n.distanceX = n.pointerStart.x - n.pointerEnd.x, n.distanceY = n.pointerStart.y - n.pointerEnd.y, Math.abs(n.distanceX) > Math.abs(n.distanceY) ? n.direction = 0 < n.distanceX ? "left" : "right" : n.direction = 0 < n.distanceY ? "up" : "down", c.onTouchMove && c.onTouchMove(t, n)
			}, r = function(t) {
				c.onTouchEnd && c.onTouchEnd(t, n), o()
			}, o = function() {
				a.removeEventListener("touchmove", i), a.removeEventListener("touchend", r, !!p.passiveSupported && {
					passive: !1
				}), a.removeEventListener("touchcancel", r)
			}, a.__lay_touchswipe_cb_ && a.removeEventListener("touchstart", a.__lay_touchswipe_cb_), a.__lay_touchswipe_cb_ = e, a.addEventListener("touchstart", e))
		...
		e = {
			...
			toVisibleArea: function(t) {
				...
				(t = s.extend({
					...
					duration: 200,
					type: "y"
				}, t)).scrollElem[0] && t.thisElem[0] && (c = t.thisElem, i = (r = "y" === t.type) ? "top" : "left", o = (e = t.scrollElem)[n = r ? "scrollTop" : "scrollLeft"](), r = e[r ? "height" : "width"](), a = e.offset()[i], u = {}, (c = c.offset()[i] - a) > r - t.margin || c < t.margin) && (u[n] = c - r / 2 + o, e.animate(u, t.duration))
			},
			on: function(i, o, t) {
				...
				if (n[0]) return n.data(a) || n.data(a, {
					events: {}
				}), a = n.data(a), e = i + "_" + t.trigger, o = a.events[e] = s.extend(!0, a.events[e], o), e = t.trigger + ".lay_util_on", n.off(e, r), n.on(e, r, function(t) {
					var e = s(this),
						n = e.attr(i);
...
layui.define(["lay", "layer", "util"], function(e) {
						...
						var e = e || a.find("input,textarea"),
							t = (i.autocomplete && e.attr("autocomplete", i.autocomplete), function(e, t) {
								var i = e.val(),
									...
									o = "click" !== t && "" === i,
									c = "init" === t;
								isNaN(a) || ("click" === t && (a = !!_(this).index() ? a - n : a + n), t = function(e) {
								...
								}).increment[r <= a && !o ? "addClass" : "removeClass"](O), n.decrement[a <= l && !o ? "addClass" : "removeClass"](O))
							});
								...
								n = function(i) {
									...
									var a, t = _('<div class="' + u + '">'),
										...
										e = _((a = [], layui.each(e, function(e, t) {
											a.push('<i class="layui-icon layui-icon-' + t + (i.disabled ? " " + O : "") + '"></i>')
										}), a.join(""))),
									...
									l[0] ? ((n = l.find("." + u))[0] && n.remove(), l.prepend(t), r.css("padding-right", function() {
										...
										_(this).hasClass(O) || ("function" == typeof i.click && i.click.call(this, r, i), layui.event.call(this, N, "input-affix(" + e + ")", {
											elem: r[0],
											affix: s,
											options: i
										}))
					...
					select: function(e) {
						var f = "\u8bf7\u9009\u62e9",
							...
							y = function(n, e, t, i, u, a) {
								var l, d, r, s, o, c, h, f, p, y = _(this),
									v = e,
									m = v.find("input"),
									g = n.find("dl"),
								...
								t || (d = "cs" === y.attr("lay-search") ? {
									...
									attr: "lay-search"
								}), r = y.attr("lay-append-to") || "body", s = y.attr("lay-append-position"), o = !(!lay.ie || "10" !== lay.ie && "11" !== lay.ie || !m.attr("placeholder")), c = function() {
									a && (n.appendTo(r).css({
										width: v.width() + "px"
									}), (e = function() {
									...
									var e = n.offset().top + n.outerHeight() + 5 - S.scrollTop(),
										t = g.outerHeight(),
										i = g.children("dd");
									k = y[0].selectedIndex, v.parent().addClass(C + "ed"), i.removeClass(j), b.removeClass(j), i.removeClass($), 0 <= k && i.eq(k).addClass($), e + t > S.height() && t <= e && n.addClass(C + "up"), f(), o && g.off("mousedown.lay_select_ieph").on("mousedown.lay_select_ieph", function() {
									...
									v.parent().removeClass(C + "ed " + C + "up"), m.blur(), u && g.children("." + T).remove(), l && l(), a && (n.detach(), _(window).off("resize.lay_select_resize")), e || p(m.val(), function(e) {
										var t = y[0].selectedIndex;
										e && (x = _(y[0].options[t]).html(), 0 === t && x === m.attr("placeholder") && (x = ""), m.val(x || ""))
									})
								}, f = function() {
									var e, t, i = g.children("dd." + $);
									...
									var e = n.keyCode,
										t = (9 === e && h(), function(e) {
											n.preventDefault();
											var t, i, a = g.children("dd:not(." + j + ",." + O + ")");
											a.length && (t = a.length - 1, i = -1, layui.each(a, function(e, t) {
												if (_(t).hasClass($)) return i = e, !0
											}), e = "prev" === e ? i - 1 < 0 ? t : i - 1 : t < i + 1 ? 0 : i + 1, a.eq(e).addClass($).siblings().removeClass($), f())
										});
									38 === e && t("prev"), 40 === e && t("next"), 13 === e && (n.preventDefault(), g.children("dd." + $).trigger("click"))
								}).on("paste", function() {
									c()
								}), p = function(n, e, l) {
									var r, s = 0,
										...
										t = (d.caseSensitive || (n = n.toLowerCase()), d.fuzzy && (r = function(e, t) {
											...
											e[(t = u ? t.not("." + T) : t).length == t.filter("." + j).length ? "addClass" : "removeClass"](j)
										}), s === t.length);
									return e(t, o), t
								}, i && m.on("input propertychange", layui.debounce(function(e) {
									var n = this.value,
										t = e.keyCode;
									return 9 !== t && 13 !== t && 37 !== t && 38 !== t && 39 !== t && 40 !== t && (o && e.target.__ieph ? e.target.__ieph = !1 : (p(n, function(e, t) {
										var i, a;
										u ? t ? g.children("." + T).remove() : (t = g.children("." + T))[0] ? t.attr("lay-value", n).html(A.escape(n)) : (t = _("<dd>").addClass(T).attr("lay-value", n).html(A.escape(n)), a = (i = g.children().eq(0)).hasClass("layui-select-tips"), i[a ? "after" : "before"](t)) : e ? g.find("." + w)[0] || g.append('<p class="' + w + '">\u65e0\u5339\u914d\u9879</p>') : g.find("." + w).remove()
									}, "keyup"), "" === n && (y.val(""), g.find("." + $).removeClass($), (y[0].options[0] || {}).value || g.children("dd:eq(0)").addClass($), g.find("." + w).remove(), u) && g.children("." + T).remove(), void f()))
								}, 50)).on("blur", function(e) {
									var t = y[0].selectedIndex;
									x = _(y[0].options[t]).text(), 0 === t && x === m.attr("placeholder") && (x = ""), setTimeout(function() {
										p(m.val(), function(e) {
											x || m.val("")
										}, "blur")
									}, 200)
									...
									var e, t = _(this),
										i = t.attr("lay-value"),
										a = y.attr("lay-filter");
									return t.hasClass(O) || (t.hasClass("layui-select-tips") ? m.val("") : (m.val(t.text()), t.addClass($)), u && t.hasClass(T) && (g.append(t.removeClass(T)), e = _("<option>").attr("value", i).text(t.text()), y.append(e)), t.siblings().removeClass($), y.val(i).removeClass("layui-form-danger"), layui.event.call(this, N, "select(" + a + ")", {
										elem: y[0],
										value: i,
										othis: n
									}), h(!0)), !1
						...
						_.event.special["_lay-select-destroy"] = {
							...
							var s, o, c = "string" == typeof i.attr("lay-search"),
								...
								h = _(['<div class="' + (c ? "" : "layui-unselect ") + C, (n ? " layui-select-disabled" : "") + '"></div>'].join("")),
								t = _(['<div class="layui-select-title">', '<input type="text" placeholder="' + A.escape(_.trim(t)) + '" value="' + A.escape(_.trim(l ? r.html() : "")) + '"' + (!n && c ? "" : " readonly") + ' class="layui-input' + (c ? "" : " layui-unselect") + (n ? " " + O : "") + '">', '<i class="layui-edge"></i>', "</div>"].join("")),
								r = _(['<dl class="layui-anim layui-anim-upbit' + (i.find("optgroup")[0] ? " layui-select-group" : "") + '">', (r = i.find("*"), s = [], layui.each(r, function(e, t) {
									var i = t.tagName.toLowerCase();
									0 !== e || t.value || "optgroup" === i ? s.push("optgroup" === i ? "<dt>" + t.label + "</dt>" : '<dd lay-value="' + A.escape(t.value) + '" class="' + (l === t.value ? $ : "") + (t.disabled ? " " + O : "") + '">' + _.trim(t.innerHTML) + "</dd>") : s.push('<dd lay-value="" class="layui-select-tips">' + _.trim(t.innerHTML || f) + "</dd>")
								}), 0 === s.length && s.push('<dd lay-value="" class="' + O + '">\u6ca1\u6709\u9009\u9879</dd>'), s.join("") + "</dl>")].join(""));
							a[0] && (d && (o = a.data(p)) && o.remove(), a.remove()), d ? (h.append(t), i.after(h), o = _('<div class="' + C + ' layui-select-panel-wrap"></div>').append(r), h.data(p, o), y.call(this, o, t, n, c, u, d)) : (h.append(t).append(r), i.after(h), y.call(this, h, t, n, c, u, d))
						})
					},
					checkbox: function(e) {
						var c = {
						...
						e.each(function(e, t) {
							...
							d && (p.call(t, "lay-form-sync-checked", t.checked), t.checked || p.call(t, "lay-form-sync-indeterminate", t.indeterminate));
							l = _(['<div class="layui-unselect ' + r[0], t.checked ? " " + r[1] : "", l ? " layui-checkbox-disabled " + O : "", '"', a ? ' lay-skin="' + a + '"' : "", ">", (s = {
							...
							i.after(l),
								function(t, i) {
									...
									t.on("click", function() {
										...
										a[0].disabled || (a[0].indeterminate && (a[0].indeterminate = !1), a[0].checked = !a[0].checked, layui.event.call(a[0], N, i[2] + "(" + e + ")", {
											elem: a[0],
											value: a[0].value,
											othis: t
										}))
					...
					radio: function(e) {
						...
						e.each(function(e, t) {
							...
							var a = A.escape(t.title || ""),
								...
								}), r = r.join(" "), _(['<div class="layui-unselect ' + o, t.checked ? " " + o + "ed" : "", (n ? " layui-radio-disabled " + O : "") + '"', l ? ' lay-skin="' + l + '"' : "", ">", '<i class="layui-anim layui-icon ' + c[t.checked ? 0 : 1] + '"></i>', "<div " + r + ">" + a + "</div>", "</div>"].join("")));
							i.after(s),
								function(i) {
									var a = _(this),
									...
									i.on("click", function() {
										var e = a.attr("lay-filter");
										a[0].disabled || (a[0].checked = !0, layui.event.call(a[0], N, "radio(" + e + ")", {
											elem: a[0],
											value: a[0].value,
											othis: i
										}))
				...
				if (s.removeClass(h), layui.each(t, function(e, t) {
						...
						if (a) {
							var n = "function" == typeof a ? i = a(c, r) : !a[0].test(c),
								...
								i = i || a[1];
							if ("required" === t && (i = s.attr("lay-reqtext") || i), n) return "tips" === o ? f.tips(i, "string" != typeof s.attr("lay-ignore") && l ? s.next() : s, {
								tips: 1
							}) : "alert" === o ? f.alert(i, {
								title: "\u63d0\u793a",
								shadeClose: !0
							}) : /\b(string|number)\b/.test(typeof i) && f.msg(i, {
								icon: 5,
								shift: 6
							}), setTimeout(function() {
	...
	}), t.on("submit", h, i).on("click", "*[lay-submit]", i), e(N, r)
});
			...
			var l, o = this,
				...
				n = ("default" === e.toolbar ? a.html(t) : "string" == typeof e.toolbar && (t = f(e.toolbar).html() || "") && a.html(m(t).render(e)), {
					...
					print: {
						...
						onClick: function(e) {
							var t = e.data;
							if (!t.length) return g.tips("\u5f53\u524d\u8868\u683c\u65e0\u6570\u636e", e.elem, {
								tips: 3
							});
				...
				e = (o.eachCols(function(e, t) {
					...
					layui.each(d.cols, function(e, n) {
						layui.each(n, function(e, t) {
							...
							t ? t.colGroup || t.hide || (o ? c && c < i ? (r--, a = i) : c && l < c && (r--, a = l) : (a = t.width || 0, /\d+%$/.test(a) ? l < (a = (a = parseFloat(a) / 100 * u) < i ? i : a) && (a = l) : a ? "normal" === t.type && (a < i && (t.width = a = i), l < a) && (t.width = a = l) : (t.width = a = 0, r++)), s += a = t.hide ? 0 : a) : n.splice(e, 1)
						})
					}), s < u && 0 < r && (c = (u - s) / r)
				}),
...
layui.define(["table"], function(e) {
	...
	a.prototype.init = function() {
		...
		var n, i, l, d, r, o, c, u, t = this.getOptions(),
			a = t.tree,
			s = a.customName;
		return e = e || P.cache[t.id], t = e, n = s.id, i = s.pid, l = s.children, d = a.data.rootPid, n = n || "id", i = i || "parentId", l = l || "children", c = {}, u = [], layui.each(t, function(e, t) {
	...
	var r, U = function(e, t, a) {
		...
		u = (B.updateNode = function(e, a, t) {
			...
			s && (i = (u = (n = s.getOptions()).tree).customName.isParent, l = u.customName.children, d = n.elem.next(), r = [], o = P.cache[e], t = s.getNodeDataByIndex("string" === layui.type(t) ? t : t[z], !1, "delete"), c = s.getNodeDataByIndex(t[f]), s.updateCheckStatus(c), u = s.treeToFlat([t], t[u.customName.pid], t[f]), layui.each(u, function(e, t) {
				t = t[z];
				r.push('tr[lay-data-index="' + t + '"]'), -1 !== t.indexOf("-") && delete o[t]
			}), d.find(r.join(",")).remove(), t = s.initData(), function() {
				...
				d.find('tr[data-level="0"][lay-data-index="' + t[z] + '"]').attr("data-index", e).data("index", e)
			}), n.hasNumberCol && v(s), c && (u = d.find('tr[lay-data-index="' + c[z] + '"]'), a || (c[i] = !(!c[l] || !c[l].length)), s.updateNodeIcon({
				scopeEl: u,
				isExpand: c[H],
				isParent: c[i]
			})), B.resize(e))
			...
			return !(a[g] = !1) === n ? a[t].length ? layui.each(a[t], function(e, t) {
				...
				t[l] && i++
			}), n = a[t].length ? a[t].length === i : a[l], a[g] = !n && 0 < i), a[l] = n, d.push(A.extend({}, a)), d = a[f] ? d.concat(this.updateParentCheckStatus(P.cache[e][a[f]], n)) : d
		}, function(e, t, a) {
			var n = this,
				i = n.getOptions(),
				l = i.tree,
