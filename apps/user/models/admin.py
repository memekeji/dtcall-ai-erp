...
class Admin(AbstractUser):
    ...
    对应原项目的mimu_admin表结构
    """
    userid = models.CharField(max_length=100, default='', verbose_name='企业微信userid')
    ...
    theme = models.CharField(max_length=50, default='white', verbose_name='系统主题')
    ...
    position_name = models.CharField(max_length=100, default='', verbose_name='职务')
    ...
    job_number = models.CharField(max_length=255, default='', verbose_name='工号')
    ...
    work_location = models.CharField(max_length=255, default='', verbose_name='工作地点')
    native_place = models.CharField(max_length=255, default='', verbose_name='籍贯')
    nation = models.CharField(max_length=255, default='', verbose_name='民族')
    home_address = models.CharField(max_length=255, default='', verbose_name='家庭地址')
    current_address = models.CharField(max_length=255, default='', verbose_name='现居地址')
    contact = models.CharField(max_length=255, default='', verbose_name='紧急联系人')
    contact_mobile = models.CharField(max_length=255, default='', verbose_name='紧急联系人电话')
    resident_type = models.IntegerField(default=0, verbose_name='户口性质:1农村户口,2城镇户口')
    resident_place = models.CharField(max_length=255, default='', verbose_name='户口所在地')
    graduate_school = models.CharField(max_length=255, default='', verbose_name='毕业学校')
    ...
    speciality = models.CharField(max_length=255, default='', verbose_name='专业')
    social_account = models.CharField(max_length=255, default='', verbose_name='社保账号')
    medical_account = models.CharField(max_length=255, default='', verbose_name='医保账号')
    provident_account = models.CharField(max_length=255, default='', verbose_name='公积金账号')
    bank_account = models.CharField(max_length=255, default='', verbose_name='银行卡号')
    bank_info = models.CharField(max_length=255, default='', verbose_name='开户行')
    file_ids = models.CharField(max_length=500, default='', verbose_name='档案附件')
    ...
    last_login_ip = models.CharField(max_length=64, default='', verbose_name='最后登录IP')
    is_lock = models.IntegerField(default=0, verbose_name='是否锁屏:1是0否')
    auth_did = models.IntegerField(default=0, verbose_name='数据权限类型')
    auth_dids = models.CharField(max_length=500, default='', verbose_name='可见部门数据')
    son_dids = models.CharField(max_length=500, default='', verbose_name='可见子部门数据')
    status = models.IntegerField(default=1, verbose_name='状态：-1待入职,0禁止登录,1正常,2离职')
    # 使用信号处理外键关系，而不是直接定义外键
    secondary_departments = models.ManyToManyField('Department', related_name='secondary_employees', blank=True, verbose_name='次要部门', through='AdminSecondaryDepartment')
