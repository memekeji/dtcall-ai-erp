...
class DepartmentDetailAPIView(LoginRequiredMixin, PermissionRequiredMixin, View):
    """部门详情API视图"""
    permission_required = 'department.view_department'
...
class DepartmentListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        def build_department_tree(departments_list, parent_id=0, level=0):
            ...
            # 获取当前层级的部门
            current_level_deps = [dept for dept in departments_list if dept.pid == parent_id]
            ...
            for dept in current_level_deps:
                ...
                # 递归获取子部门
                children = build_department_tree(departments_list, dept.id, level + 1)
