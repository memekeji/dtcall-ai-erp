...
urlpatterns = [
    ...
    path(
        'menu/<int:pk>/',
        menu_views.MenuDetailAPIView.as_view(),
        name='menu_detail'),
    path(
        'menu/<int:menu_id>/permissions/',
        MenuPermissionsAPIView.as_view(),
    ...
    # 员工专项管理
    path(
        'employee/<int:pk>/file/',
        EmployeeFileView.as_view(),
        name='employee_file'),
    path(
        'employee/transfer/',
        EmployeeTransferListView.as_view(),
        name='employee_transfer_list'),
    path(
        'employee/dimission/',
        EmployeeDimissionListView.as_view(),
        name='employee_dimission_list'),

    # 奖惩管理
    path(
        'reward-punishment/',
        RewardPunishmentListView.as_view(),
        name='reward_punishment_list'),
    path(
        'reward-punishment/add/',
        RewardPunishmentCreateView.as_view(),
        name='reward_punishment_add'),
    path('reward-punishment/<int:pk>/edit/',
         RewardPunishmentUpdateView.as_view(),
         name='reward_punishment_edit'),
    path('reward-punishment/<int:pk>/delete/',
         RewardPunishmentDeleteView.as_view(),
         name='reward_punishment_delete'),

    # 员工关怀管理
    path(
        'employee-care/',
        EmployeeCareListView.as_view(),
        name='employee_care_list'),
    path(
        'employee-care/add/',
        EmployeeCareCreateView.as_view(),
        name='employee_care_add'),
    path(
        'employee-care/<int:pk>/edit/',
        EmployeeCareUpdateView.as_view(),
        name='employee_care_edit'),
    path(
        'employee-care/<int:pk>/delete/',
        EmployeeCareDeleteView.as_view(),
        name='employee_care_delete'),

    # 员工合同管理
    path(
        'employee-contract/',
        EmployeeContractListView.as_view(),
        name='employee_contract_list'),
    path(
        'employee-contract/add/',
        EmployeeContractCreateView.as_view(),
        name='employee_contract_add'),
    path('employee-contract/<int:pk>/',
         EmployeeContractDetailView.as_view(),
         name='employee_contract_detail'),
    path('employee-contract/<int:pk>/edit/',
         EmployeeContractUpdateView.as_view(),
         name='employee_contract_edit'),
    path('employee-contract/<int:pk>/delete/',
         EmployeeContractDeleteView.as_view(),
    ...
    path(
        'department/<int:pk>/',
        department_views.DepartmentDetailAPIView.as_view(),
        name='department_detail'),
    # 部门角色管理
    path('department/<int:department_id>/roles/',
         DepartmentRoleManagementView.as_view(),
         name='department_role_management'),
    path(
        'department/<int:department_id>/roles/list/',
        DepartmentRoleListAPIView.as_view(),
        name='department_role_list'),
    ...
    path(
        'group/<int:pk>/',
        group_views.GroupDetailAPIView.as_view(),
        name='group_detail'),
    path(
        'group/<int:pk>/update/',
        ...
        name='group_update'),
    path(
        'group/<int:pk>/toggle-status/',
        group_views.GroupStatusToggleView.as_view(),
        name='group_toggle_status'),
    path(
        'group/<int:pk>/permission/',
        GroupPermissionView.as_view(),
        name='group_permission'),
    # 获取所有角色（权限组）数据
    path(
        'group/all/',
        group_views.GetGroupsAPIView.as_view(),
        name='get_all_groups'),
    ...
    path(
        'log/<int:pk>/',
        log_views.LogDetailAPIView.as_view(),
        name='log_detail'),
    ...
    path(
        'center/update/',
        EmployeeCenterUpdateView.as_view(),
        name='employee_center_update'),

    # 密码重置和状态变更API
    path(
        'employee/<int:pk>/reset-password/',
        ResetPasswordView.as_view(),
        name='employee_reset_password'),
    path(
        'employee/<int:pk>/change-status/',
