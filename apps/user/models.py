...
class EmployeeFile(models.Model):
    ...
    employee = models.OneToOneField(User, on_delete=models.CASCADE, verbose_name='员工', related_name='user_employee_file')
...
class EmployeeTransfer(models.Model):
    ...
    employee = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='员工', related_name='user_transfers')
    from_department = models.ForeignKey(Department, on_delete=models.CASCADE, related_name='user_transfer_from', verbose_name='原部门')
    to_department = models.ForeignKey(Department, on_delete=models.CASCADE, related_name='user_transfer_to', verbose_name='调入部门')
    ...
    applicant = models.ForeignKey(User, on_delete=models.CASCADE, related_name='user_transfer_applications', verbose_name='申请人')
    approver = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='user_transfer_approvals', verbose_name='审批人')
    ...
    def __str__(self):
        return f"{self.employee.username} - {self.from_department.name} -> {self.to_department.name}"
...
class EmployeeDimission(models.Model):
    ...
    employee = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='员工', related_name='user_dimissions')
    ...
    handover_person = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='user_handover_tasks', verbose_name='交接人')
    handover_content = models.TextField(blank=True, verbose_name='交接内容')
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='pending', verbose_name='状态')
    approver = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='user_dimission_approvals', verbose_name='审批人')
    approve_time = models.DateTimeField(null=True, blank=True, verbose_name='审批时间')
    approve_comment = models.TextField(blank=True, verbose_name='审批意见')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='申请时间')
    updated_at = models.DateTimeField(auto_now=True, verbose_name='更新时间')
...
class RewardPunishment(models.Model):
    ...
    employee = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='员工', related_name='user_rewards')
    ...
    executor = models.ForeignKey(User, on_delete=models.CASCADE, related_name='user_executed_rewards', verbose_name='执行人')
    remarks = models.TextField(blank=True, verbose_name='备注')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
    updated_at = models.DateTimeField(auto_now=True, verbose_name='更新时间')
...
class EmployeeCare(models.Model):
    ...
    employee = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='员工', related_name='user_cares')
    ...
    executor = models.ForeignKey(User, on_delete=models.CASCADE, related_name='user_executed_cares', verbose_name='执行人')
    remarks = models.TextField(blank=True, verbose_name='备注')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
    updated_at = models.DateTimeField(auto_now=True, verbose_name='更新时间')
...
class EmployeeContract(models.Model):
    ...
    employee = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='员工', related_name='user_contracts')
    ...
    sign_person = models.ForeignKey(User, on_delete=models.CASCADE, related_name='signed_contracts', verbose_name='签订人')
    remarks = models.TextField(blank=True, verbose_name='备注')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
    updated_at = models.DateTimeField(auto_now=True, verbose_name='更新时间')
