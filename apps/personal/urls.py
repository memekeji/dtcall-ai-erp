...
urlpatterns = [
    ...
    path('record/<int:pk>/edit/', views.work_record_form, name='work_record_edit'),
    path('record/<int:pk>/delete/', views.work_record_delete, name='work_record_delete'),
    ...
    path('report/<int:pk>/edit/', views.work_report_form, name='work_report_edit'),
    path('report/<int:pk>/delete/', views.work_report_delete, name='work_report_delete'),
    path('report/<int:pk>/view/', views.work_report_detail, name='work_report_detail'),
    ...
    path('minutes/<int:pk>/view/', views.minutes_detail, name='minutes_detail'),
    path('minutes/download/<int:pk>/', views.generate_minutes_word, name='minutes_download'),
    path('minutes/preview/<int:pk>/', views.generate_minutes_preview, name='minutes_preview'),
]