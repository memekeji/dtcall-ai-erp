    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='', max_length=255, verbose_name='审批标题')),
                ...
                ('status', models.PositiveSmallIntegerField(default=1, verbose_name='审批状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('step_type', models.CharField(max_length=20, choices=[('user', '指定用户'), ('role', '指定角色'), ('department', '指定部门'), ('level', '指定级别'), ('custom', '自定义条件')], default='user', verbose_name='步骤类型')),
                ('action_type', models.CharField(max_length=20, choices=[('approve', '审批'), ('review', '审阅'), ('sign', '会签'), ('notify', '通知')], default='approve', verbose_name='操作类型')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('flow', models.ForeignKey(on_delete=models.CASCADE, related_name='steps', to='approval.approvalflow', verbose_name='所属流程')),
            ],
            options={
                'verbose_name': '审批步骤',
