...
class Approval(models.Model):
    ...
    check_time = models.BigIntegerField(verbose_name="审批时间", default=0)
    check_status = models.SmallIntegerField(
        default=0,
        verbose_name="审批状态",
        choices=[(0, '发起'), (1, '通过'), (2, '拒绝'), (3, '撤销')]
    )
    content = models.CharField(max_length=500, default='', verbose_name="审批意见")
...
class Schedule(models.Model):
    """工作日程"""
    work_id = models.PositiveIntegerField(default=0, verbose_name='汇报工作ID')
