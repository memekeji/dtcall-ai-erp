...
class CustomerFilter(filters.FilterSet):
    ...
    create_time_start = filters.DateTimeFilter(field_name='create_time', lookup_expr='gte')
    create_time_end = filters.DateTimeFilter(field_name='create_time', lookup_expr='lte')
