...
urlpatterns = [
    ...
    path('outsource/<int:pk>/', views.outsource_detail, name='outsource_detail'),
    ...
    path('pr-review/<int:pk>/', views.pr_review_detail, name='pr_review_detail'),
    ...
    path('price-review/<int:pk>/', views.price_review_detail, name='price_review_detail'),
