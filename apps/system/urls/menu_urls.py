...
urlpatterns = [
    ...
    path('update/<int:pk>/', menu_views.MenuUpdateView.as_view(), name='menu_update'),
    path('delete/<int:pk>/', menu_views.MenuDeleteView.as_view(), name='menu_delete'),
    ...
    path('get_groups/', lambda request: redirect('/user/group/all/', permanent=True), name='get_groups'),
]