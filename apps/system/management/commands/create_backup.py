...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--type', type=str, default='full', help='Backup type: full, incremental, differential')
        parser.add_argument('--description', type=str, default='', help='Backup description')
        ...
        try:
            ...
            def async_backup():
                try:
                    ...
                    self.stdout.write(self.style.SUCCESS(f'数据备份创建成功：{backup.name}，文件大小：{file_size}字节'))
            ...
            self.stdout.write(self.style.SUCCESS(f'数据{backup.get_backup_type_display()}任务已创建，正在后台执行中！'))
        except Exception as e:
