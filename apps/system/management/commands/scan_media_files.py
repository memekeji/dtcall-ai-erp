        ...
        for root, dirs, files in os.walk(media_root):
            for file_name in files:
                ...
                file_type = os.path.splitext(
                    file_name)[1].lower() if '.' in file_name else ''
                ...
                if added_files % 100 == 0:
                    self.stdout.write(
                        f"已处理 {total_files} 个文件，新增 {added_files} 个，已存在 {existing_files} 个")
