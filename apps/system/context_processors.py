...
MENU_URL_TO_PERMISSION_MAP = {
    ...
    '/project/ai/risk-prediction': 'view_risk_prediction',
    '/project/ai/risk-prediction/': 'view_risk_prediction',
    ...
    '/production/material/': 'view_production',
    ...
    '/production/material/scrap/': 'view_production',
    ...
    '/production/product/receipt/': 'view_production',
    '/production/order/confirmation/': 'view_production',
    '/production/resource/consumption/': 'view_production',
    '/supply-chain/': 'view_supply_chain_dashboard',
    '/supply-chain/inventory-analysis/': 'view_supply_chain_inventory_analysis',
    ...
    '/user/group/list/': 'view_role',
    '/user/group/2/permission/': 'config_role_permission',
    ...
    '/personal/workcalendar/': 'view_work_calendar',
    ...
    '/message/conversations/page/': 'view_conversation_center',
    '/message/page/': 'view_message_center',
    '/message/preference/': 'view_message_preference',
    '/message/stats/page/': 'view_message_stats',
    '/finance/': 'view_finance',
