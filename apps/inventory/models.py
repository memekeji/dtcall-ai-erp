...
class Inventory(models.Model):
    ...
    batch_number = models.CharField(
        max_length=50, blank=True, verbose_name='批次号')
    ...
    available_quantity = models.DecimalField(
        max_digits=12, decimal_places=4, default=0, verbose_name='可用数量')
...
class StockTransaction(models.Model):
    ...
    reference_type = models.CharField(
        max_length=50, blank=True, verbose_name='关联单据类型')
    reference_id = models.BigIntegerField(default=0, verbose_name='关联单据ID')
    reference_code = models.CharField(
        max_length=50, blank=True, verbose_name='关联单据编号')
...
class StockIn(models.Model):
    ...
    stock_time = models.DateTimeField(
        null=True, blank=True, verbose_name='入库时间')
    remark = models.TextField(blank=True, verbose_name='备注')
    create_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
    update_time = models.DateTimeField(auto_now=True, verbose_name='更新时间')
...
class StockOut(models.Model):
    ...
    stocker = models.ForeignKey(
        ...
        verbose_name='出库人')
    stock_time = models.DateTimeField(
        null=True, blank=True, verbose_name='出库时间')
    remark = models.TextField(blank=True, verbose_name='备注')
    create_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
    update_time = models.DateTimeField(auto_now=True, verbose_name='更新时间')
...
class StockTransferItem(models.Model):
    ...
    amount = models.DecimalField(
        ...
        default=0,
        verbose_name='金额')
    transferred_quantity = models.DecimalField(
        max_digits=12, decimal_places=4, default=0, verbose_name='已调拨数量')
    remark = models.TextField(blank=True, verbose_name='备注')
...
class StockCheck(models.Model):
    ...
    checker = models.ForeignKey(
        ...
        verbose_name='盘点人')
    check_time = models.DateTimeField(
        null=True, blank=True, verbose_name='盘点时间')
    complete_time = models.DateTimeField(
        null=True, blank=True, verbose_name='完成时间')
    remark = models.TextField(blank=True, verbose_name='备注')
    create_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
...
class PurchaseOrder(models.Model):
    ...
    expected_date = models.DateField(
        null=True, blank=True, verbose_name='期望到货日期')
    actual_date = models.DateField(
        null=True, blank=True, verbose_name='实际到货日期')
    status = models.IntegerField(
        choices=STATUS_CHOICES,
        default=1,
        verbose_name='状态')
    ...
    delivery_address = models.CharField(
        max_length=500, blank=True, verbose_name='交货地址')
    payment_terms = models.CharField(
        max_length=100, blank=True, verbose_name='付款条件')
    remark = models.TextField(blank=True, verbose_name='备注')
    create_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
    update_time = models.DateTimeField(auto_now=True, verbose_name='更新时间')
...
class SalesOrder(models.Model):
    ...
    total_quantity = models.DecimalField(
        ...
        default=0,
        verbose_name='订单数量')
    shipped_amount = models.DecimalField(
        max_digits=15,
        decimal_places=2,
        default=0,
        verbose_name='已发货金额')
    ...
    order_date = models.DateField(verbose_name='订单日期')
    expected_date = models.DateField(
        null=True, blank=True, verbose_name='期望发货日期')
    actual_date = models.DateField(
        null=True, blank=True, verbose_name='实际发货日期')
    status = models.IntegerField(
        choices=STATUS_CHOICES,
        default=1,
        verbose_name='状态')
    ...
    shipping_address = models.CharField(
        max_length=500, blank=True, verbose_name='收货地址')
    payment_terms = models.CharField(
        max_length=100, blank=True, verbose_name='付款条件')
