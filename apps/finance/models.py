...
class Expense(models.Model):
    ...
    def get_check_status_display(self):
        return FinanceStatusMapping.CHECK_STATUS_MAP.get(
            self.check_status, '未知')
...
class Invoice(models.Model):
    ...
    invoice_address = models.CharField(
        max_length=100, default='', verbose_name='地址')
    invoice_bank = models.CharField(
        max_length=100, default='', verbose_name='开户银行')
    ...
    def get_enter_status_display(self):
        return FinanceStatusMapping.ENTER_STATUS_MAP.get(
            self.enter_status, '未知')

    def get_invoice_type_display(self):
        return FinanceStatusMapping.INVOICE_TYPE_MAP.get(
            self.invoice_type, '未知')
