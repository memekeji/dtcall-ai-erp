...
from . import views
from .ai_views import ai_production_optimization
...
urlpatterns = [
    # AI 路由
    path('api/ai/optimization/<int:plan_id>/', ai_production_optimization, name='ai_production_optimization'),
    ...
    path(
        'procedure/edit/<int:pk>/',
        views.procedure_edit,
        name='procedure_edit'),
    path(
        'procedure/delete/<int:pk>/',
        views.procedure_delete,
    ...
    path(
        'procedureset/delete/<int:pk>/',
        views.procedureset_delete,
        name='procedureset_delete'),
    ...
    path(
        'data/source/<int:pk>/',
        views.data_source_detail,
        name='data_source_detail'),
    path(
        'data/source/<int:pk>/edit/',
        views.data_source_edit,
        name='data_source_edit'),
    path(
        'data/source/<int:pk>/delete/',
    ...
    path(
        'data/mapping/<int:pk>/edit/',
        views.data_mapping_edit,
        name='data_mapping_edit'),
    path(
    ...
    path(
        'data/record/',
        views.data_collection_record_list,
        name='data_collection_record_list'),
    path(
        'data/record/<int:pk>/',
        views.data_collection_record_detail,
        name='data_collection_record_detail'),
    ...
    path(
        'data/task/',
        views.data_collection_task_list,
        name='data_collection_task_list'),
    path(
        'data/task/add/',
        views.data_collection_task_add,
        name='data_collection_task_add'),
    path('data/task/<int:pk>/edit/',
         views.data_collection_task_edit,
         name='data_collection_task_edit'),
    path('data/task/<int:pk>/delete/',
         views.data_collection_task_delete,
         name='data_collection_task_delete'),
    path('data/task/<int:pk>/trigger/',
         views.data_collection_task_trigger,
         name='data_collection_task_trigger'),
    ...
    path(
        'task/plan/',
        views.production_plan_list,
        name='production_plan_list'),
    path(
        'task/plan/add/',
        views.production_plan_add,
        name='production_plan_add'),
    path(
        'task/plan/edit/<int:pk>/',
        views.production_plan_edit,
        name='production_plan_edit'),
    path(
        'task/plan/delete/<int:pk>/',
        views.production_plan_delete,
        name='production_plan_delete'),
    path(
        'task/plan/detail/<int:pk>/',
        views.production_plan_detail,
    ...
    path(
        'task/execution/add/',
        views.production_task_add,
        name='production_task_add'),
    path(
        'task/execution/edit/<int:pk>/',
        views.production_task_edit,
        name='production_task_edit'),
    path(
        'task/execution/delete/<int:pk>/',
        views.production_task_delete,
        name='production_task_delete'),
    path(
        'task/execution/detail/<int:pk>/',
        views.production_task_detail,
        name='production_task_detail'),
    path(
        'task/execution/start/<int:pk>/',
        views.production_task_start,
        name='production_task_start'),
    path(
        'task/execution/complete/<int:pk>/',
        views.production_task_complete,
        name='production_task_complete'),
    path(
        'task/execution/quality/<int:pk>/',
        views.production_task_quality,
        name='production_task_quality'),
    path(
        'task/execution/suspend/<int:pk>/',
        views.production_task_suspend,
        name='production_task_suspend'),
    path(
        'task/execution/resume/<int:pk>/',
    ...
    path(
        'quality/edit/<int:pk>/',
        views.quality_check_edit,
        name='quality_check_edit'),
    path(
        'quality/delete/<int:pk>/',
        views.quality_check_delete,
        name='quality_check_delete'),
    path(
        'quality/detail/<int:pk>/',
        views.quality_check_detail,
    ...
    path(
        'process/edit/<int:pk>/',
        views.process_route_edit,
        name='process_route_edit'),
    path(
        'process/delete/<int:pk>/',
        views.process_route_delete,
        name='process_route_delete'),
    path(
        'process/detail/<int:pk>/',
        views.process_route_detail,
        name='process_route_detail'),
    path(
        'process/copy/<int:pk>/',
        views.process_route_copy,
        name='process_route_copy'),

    # 资源调度
    path('technology/', views.resource_scheduling, name='resource_scheduling'),
    path(
        'scheduling/optimize/',
        views.scheduling_optimize,
        name='scheduling_optimize'),
    path('scheduling/bottleneck/',
         views.scheduling_bottleneck_analysis,
         name='scheduling_bottleneck_analysis'),
    path(
        'scheduling/simulation/<int:plan_id>/',
        views.scheduling_simulation,
        name='scheduling_simulation'),
    path('scheduling/gantt/', views.gantt_chart_data, name='gantt_chart_data'),
    path(
        'delivery/prediction/',
        views.delivery_prediction,
        name='delivery_prediction'),
    path(
        'delivery/prediction/<int:plan_id>/',
        views.delivery_prediction,
        name='delivery_prediction_detail'),

    # 实时监控
    path(
        'monitor/realtime/',
        views.equipment_monitor_realtime,
        name='equipment_monitor_realtime'),
    path(
        'monitor/status/<int:equipment_id>/',
        views.equipment_status_api,
        name='equipment_status_api'),
    path(
        'monitor/data/<int:equipment_id>/',
        views.equipment_data_history,
        name='equipment_data_history'),
    path(
        'monitor/oee/<int:equipment_id>/',
        views.equipment_oee,
        name='equipment_oee'),
    path(
        'monitor/progress/',
        views.production_progress,
        name='production_progress'),
    path(
        'monitor/progress/<int:plan_id>/',
        views.production_progress,
        name='production_progress_plan'),

    # 告警管理
    path('alert/', views.alert_list, name='alert_list'),
    path('alert/api/', views.alert_api, name='alert_api'),
    path(
        'alert/acknowledge/<str:alert_id>/',
    ...
    path(
        'statistics/summary/',
        views.statistics_production_summary,
        name='statistics_production_summary'),
    path(
        'statistics/trend/',
        views.statistics_production_trend,
        name='statistics_production_trend'),
    path(
        'statistics/quality/',
        views.statistics_quality,
        name='statistics_quality'),
    path(
        'statistics/equipment/',
        views.statistics_equipment_efficiency,
        name='statistics_equipment_efficiency'),
    path(
        'statistics/labor/',
        views.statistics_labor_efficiency,
        name='statistics_labor_efficiency'),
    path('statistics/cost/', views.statistics_cost, name='statistics_cost'),
    path(
        'statistics/delivery/',
        views.statistics_on_time_delivery,
        name='statistics_on_time_delivery'),
    path(
        'statistics/report/',
        views.statistics_comprehensive_report,
        name='statistics_comprehensive_report'),

    # 生产订单变更
    path(
        'order/change/',
        views.production_order_change_list,
        name='production_order_change_list'),
    path(
        'order/change/add/',
        views.production_order_change_add,
        name='production_order_change_add'),
    path('order/change/<int:pk>/edit/',
         views.production_order_change_edit,
         name='production_order_change_edit'),
    path('order/change/<int:pk>/approve/',
         views.production_order_change_approve,
         name='production_order_change_approve'),
    path('order/change/<int:pk>/execute/',
         views.production_order_change_execute,
         name='production_order_change_execute'),

    # 生产线日计划
    path(
        'line/dayplan/',
        views.production_line_day_plan_list,
        name='production_line_day_plan_list'),
    path(
        'line/dayplan/add/',
        views.production_line_day_plan_add,
        name='production_line_day_plan_add'),
    path('line/dayplan/<int:pk>/edit/',
         views.production_line_day_plan_edit,
         name='production_line_day_plan_edit'),
    path('line/dayplan/<int:pk>/delete/',
    ...
    path(
        'material/request/<int:pk>/approve/',
        views.material_request_approve,
        name='material_request_approve'),
    path(
    ...
    path(
        'material/return/<int:pk>/approve/',
    ...
    path(
        ...
        name='work_completion_report_list'),
    path('completion/report/add/',
         views.work_completion_report_add,
         name='work_completion_report_add'),
    path('completion/report/<int:pk>/edit/',
         views.work_completion_report_edit,
         name='work_completion_report_edit'),
    path('completion/report/<int:pk>/approve/',
         views.work_completion_report_approve,
         name='work_completion_report_approve'),
    ...
    path(
        ...
        name='work_completion_red_flush_list'),
    path('completion/red-flush/add/',
         views.work_completion_red_flush_add,
         name='work_completion_red_flush_add'),
    path('completion/red-flush/<int:pk>/approve/',
         views.work_completion_red_flush_approve,
         name='work_completion_red_flush_approve'),
    ...
    path(
        'product/receipt/<int:pk>/approve/',
    ...
    path(
        ...
        name='order_material_confirmation_list'),
    ...
    path(
        ...
        name='resource_consumption_list'),
