    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=50, unique=True, verbose_name="BOM编码"),
                ),
                (
                    "version",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "total_cost",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=12, verbose_name="总价"
                    ),
                ),
                (
                    "supplier",
                    models.CharField(blank=True, max_length=100, verbose_name="供应商"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "parameter_name",
                    models.CharField(max_length=50, verbose_name="参数名称"),
                ),
                (
                    "parameter_value",
                    models.DecimalField(
                        decimal_places=4, max_digits=10, verbose_name="参数值"
                    ),
                ),
                ("unit", models.CharField(max_length=20, verbose_name="单位")),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "processed_data",
                    models.JSONField(blank=True, default=dict, verbose_name="处理后数据"),
                ),
                ...
                (
                    "error_details",
                    models.JSONField(blank=True, default=list, verbose_name="错误详情"),
                ),
                (
                    "start_time",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "transform_params",
                    models.JSONField(blank=True, default=dict, verbose_name="转换参数"),
                ),
                (
                    "is_required",
                ...
                (
                    "regex_pattern",
                    models.CharField(blank=True, max_length=500, verbose_name="正则表达式"),
                ),
                ("default_value", models.TextField(blank=True, verbose_name="默认值")),
                (
                    "target_table",
                    models.CharField(blank=True, max_length=100, verbose_name="目标表"),
                ),
                (
                    "target_field",
                    models.CharField(blank=True, max_length=100, verbose_name="目标字段"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=50, unique=True, verbose_name="数据源编码"),
                ),
                (
                    "source_type",
                    models.CharField(
                ...
                (
                    "host",
                    models.CharField(blank=True, max_length=255, verbose_name="主机地址"),
                ),
                ...
                (
                    "request_method",
                    models.CharField(default="GET", max_length=10, verbose_name="请求方法"),
                ),
                (
                    "request_headers",
                ...
                (
                    "last_success_time",
                    models.DateTimeField(blank=True, null=True, verbose_name="最后成功时间"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=50, unique=True, verbose_name="设备编号"),
                ),
                (
                    "model",
                ...
                (
                    "manufacturer",
                    models.CharField(blank=True, max_length=100, verbose_name="制造商"),
                ),
                (
                    "purchase_date",
                ...
                (
                    "location",
                    models.CharField(blank=True, max_length=100, verbose_name="设备位置"),
                ),
                (
                    "status",
                    models.IntegerField(
                        choices=[(1, "正常"), (2, "维修中"), (3, "停用"), (4, "报废")],
                        default=1,
                        verbose_name="设备状态",
                    ),
                ),
                (
                    "maintenance_cycle",
                    models.IntegerField(default=30, verbose_name="维护周期(天)"),
                ),
                (
                    "last_maintenance",
                    models.DateField(blank=True, null=True, verbose_name="上次维护日期"),
                ),
                (
                    "next_maintenance",
                    models.DateField(blank=True, null=True, verbose_name="下次维护日期"),
                ),
            ...
            bases=(models.Model, apps.production.models.StatusDisplayMixin),
        ),
        migrations.CreateModel(
            name="MaterialIssue",
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "issue_quantity",
                    models.DecimalField(
                        decimal_places=4, max_digits=10, verbose_name="出库数量"
                    ),
                ),
                (
                    "unit_cost",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=50, unique=True, verbose_name="申请单号"),
                ),
                (
                    "request_date",
                    models.DateField(
                        default=django.utils.timezone.now, verbose_name="申请日期"
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "request_quantity",
                    models.DecimalField(
                        decimal_places=4, max_digits=10, verbose_name="申请数量"
                    ),
                ),
                (
                    "issued_quantity",
                    models.DecimalField(
                        decimal_places=4, default=0, max_digits=10, verbose_name="已发数量"
                    ),
                ),
                (
                    "unit_cost",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=50, unique=True, verbose_name="退料单号"),
                ),
                (
                    "return_date",
                    models.DateField(
                        default=django.utils.timezone.now, verbose_name="退料日期"
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "return_quantity",
                    models.DecimalField(
                        decimal_places=4, max_digits=10, verbose_name="退料数量"
                    ),
                ),
                (
                    "unit_cost",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "confirmed_quantity",
                    models.DecimalField(
                        decimal_places=4, max_digits=10, verbose_name="确认数量"
                    ),
                ),
                (
                    "confirm_time",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="确认时间"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=50, unique=True, verbose_name="工序集编码"),
                ),
                ("description", models.TextField(blank=True, verbose_name="工序集描述")),
                (
                    "total_time",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=10, verbose_name="总工时"
                    ),
                ),
                (
                    "total_cost",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "estimated_time",
                    models.DecimalField(
                        decimal_places=2, max_digits=8, verbose_name="预估工时"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=50, unique=True, verbose_name="工艺路线编码"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "workstation",
                    models.CharField(blank=True, max_length=100, verbose_name="工位"),
                ),
                ("work_instruction", models.TextField(blank=True, verbose_name="作业指导")),
                (
                    "quality_check_points",
                    models.TextField(blank=True, verbose_name="质量检查点"),
                ),
                (
                    "cycle_time",
                    models.DecimalField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quality",
                    models.CharField(
                        default="good", max_length=20, verbose_name="数据质量"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=50, unique=True, verbose_name="日计划编号"),
                ),
                (
                    "production_line",
                    models.CharField(max_length=50, verbose_name="生产线"),
                ),
                ("plan_date", models.DateField(verbose_name="计划日期")),
                (
                    "quantity",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="计划数量"
                    ),
                ),
                (
                    "completed_quantity",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=10, verbose_name="完成数量"
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.IntegerField(
                        choices=[(1, "待审核"), (2, "已审核"), (3, "已执行"), (4, "已拒绝")],
                        default=1,
                        verbose_name="状态",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=50, unique=True, verbose_name="计划编号"),
                ),
                (
                    "quantity",
                    models.DecimalField(
                ...
                (
                    "actual_start_date",
                    models.DateField(blank=True, null=True, verbose_name="实际开始日期"),
                ),
                (
                    "actual_end_date",
                    models.DateField(blank=True, null=True, verbose_name="实际结束日期"),
                ),
                (
                    "status",
                    models.IntegerField(
                ...
                (
                    "auto_complete",
                    models.BooleanField(default=False, verbose_name="是否自动完工"),
                ),
                (
                    "complete_threshold",
                    models.DecimalField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=50, unique=True, verbose_name="工序编码"),
                ),
                ...
                (
                    "cost_per_hour",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=10, verbose_name="每小时成本"
                    ),
                ),
                ("sort", models.IntegerField(default=0, verbose_name="排序")),
                ("status", models.BooleanField(default=True, verbose_name="是否启用")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="任务数量"
                    ),
                ),
                (
                    "completed_quantity",
                ...
                (
                    "qualified_quantity",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=10, verbose_name="合格数量"
                    ),
                ),
                (
                    "defective_quantity",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=10, verbose_name="不合格数量"
                    ),
                ),
                ...
                (
                    "suspended_time",
                    models.DateTimeField(blank=True, null=True, verbose_name="挂起时间"),
                ),
            ...
            bases=(
                models.Model,
                apps.production.models.StatusDisplayMixin,
                apps.production.models.RateCalculationMixin,
            ),
        ),
        migrations.CreateModel(
            name="ProductReceipt",
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=50, unique=True, verbose_name="成品入库单号"),
                ),
                (
                    "receipt_date",
                    models.DateField(
                ...
                (
                    "receipt_quantity",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="入库数量"
                    ),
                ),
                (
                    "storage_location",
                    models.CharField(max_length=100, verbose_name="存储位置"),
                ),
                (
                    "status",
                    models.IntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "check_time",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="检查时间"
                    ),
                ),
                (
                    "check_quantity",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="检查数量"
                    ),
                ),
                (
                    "qualified_quantity",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="合格数量"
                    ),
                ),
                (
                    "defective_quantity",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="不合格数量"
                    ),
                ),
                (
                    "result",
                    models.IntegerField(
                        choices=[(1, "合格"), (2, "不合格"), (3, "待检")],
                        default=3,
                        verbose_name="检查结果",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "consumed_quantity",
                    models.DecimalField(
                        decimal_places=4, max_digits=10, verbose_name="消耗数量"
                    ),
                ),
                ("unit", models.CharField(max_length=20, verbose_name="单位")),
                (
                    "cost",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=12, verbose_name="成本"
                    ),
                ),
                (
                    "consumption_time",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="消耗时间"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=50, unique=True, verbose_name="SOP编号"),
                ),
                (
                    "version",
                    models.CharField(default="1.0", max_length=20, verbose_name="版本号"),
                ...
                (
                    "safety_requirements",
                    models.TextField(blank=True, verbose_name="安全要求"),
                ),
                (
                    "quality_standards",
                    models.TextField(blank=True, verbose_name="质量标准"),
                ),
                ("tools_required", models.TextField(blank=True, verbose_name="所需工具")),
                (
                    "file_path",
                    models.CharField(blank=True, max_length=500, verbose_name="附件路径"),
                ),
                ("status", models.BooleanField(default=True, verbose_name="是否启用")),
                (
                    "create_time",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=50, unique=True, verbose_name="红冲单号"),
                ),
                (
                    "red_flush_date",
                    models.DateField(
                        default=django.utils.timezone.now, verbose_name="红冲日期"
                    ),
                ),
                ...
                (
                    "red_flush_quantity",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="红冲数量"
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(max_length=50, unique=True, verbose_name="完工申报单号"),
                ),
                (
                    "report_date",
                    models.DateField(
                        default=django.utils.timezone.now, verbose_name="申报日期"
                    ),
                ),
                (
                    "reported_quantity",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="申报数量"
                    ),
                ),
                (
                    "qualified_quantity",
                ...
                (
                    "status",
                    models.IntegerField(
                        choices=[(1, "待审核"), (2, "已审核"), (3, "已红冲"), (4, "已取消")],
                        default=1,
                        verbose_name="状态",
                    ),
                ),
                (
                    "work_hours",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=8, verbose_name="实际工时"
                    ),
                ),
                (
                    "resource_consumption",
                    models.JSONField(blank=True, default=dict, verbose_name="资源消耗"),
                ),
                ("remarks", models.TextField(blank=True, verbose_name="备注")),
                (
                    "create_time",
