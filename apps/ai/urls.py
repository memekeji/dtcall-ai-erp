...
urlpatterns = [
    ...
    path('model-config/delete/<int:pk>/', views.AIModelConfigDeleteView.as_view(), name='model_config_delete'),
    ...
    path('workflow/<uuid:pk>/delete/', views.AIWorkflowDeleteView.as_view(), name='workflow_delete'),
    path('workflow/detail/<uuid:pk>/', views.AIWorkflowJsonDetailView.as_view(), name='workflow_detail'),
    path('workflow/html/<uuid:pk>/', views.AIWorkflowDetailView.as_view(), name='workflow_html_detail'),
