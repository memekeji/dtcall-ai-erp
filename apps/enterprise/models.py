...
class Enterprise(models.Model):
    ...
    tax_num = models.CharField(max_length=100, verbose_name='纳税人识别号', default='')
    ...
    status = models.SmallIntegerField(default=1, verbose_name='状态', help_text='状态：-1删除 0禁用 1启用', db_column='status')
