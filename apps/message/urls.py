...
router.register(r'categories', views.MessageCategoryViewSet, basename='message-category')
...
urlpatterns = [
    ...
    path('mark-read/', views.MessageMarkReadView.as_view(), name='message-mark-read'),
